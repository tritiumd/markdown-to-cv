...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({"name": "John Doe", "position": "Software Engineer"}, 422,
         "Validation error"),  # Missing required fields
        ({"name": "John Doe", "position": "Software Engineer", "info": []}, 422,
         "Validation error"),  # Missing required fields
        ({"name": "John Doe", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications."},
         422, "Validation error"),  # Missing required fields
        ({"name": "John Doe" * 1000, "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Name too long
        ({"name": "", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Name too short
        ({"name": "John Doe", "position": "" * 1000,
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Position too long
        ({"name": "John Doe", "position": "",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Position too short
        ({"name": "John Doe", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications." * 1000,
          "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Summary too long
        ({"name": "John Doe", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "", "skill": "Python, Java, JavaScript, SQL, AWS"}, 422,
         "Validation error"),  # Summary too short
        ({"name": "John Doe", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": "Python, Java, JavaScript, SQL, AWS" * 1000}, 422,
         "Validation error"),  # Skill too long
        ({"name": "John Doe", "position": "Software Engineer",
          "info": [{"icon": "phone", "data": "+1-555-123-4567"}],
          "summary": "A highly motivated software engineer with 5+ years of experience in developing web applications.",
          "skill": ""}, 422, "Validation error"),  # Skill too short
    ],
)
